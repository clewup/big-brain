...
export const mockBlogPost: BlogPostType = {
    _id: '1',
    ...
    date: new Date(),
    tags: [CategoriesEnum.NEXTJS, CategoriesEnum.TYPESCRIPT],
};
...
export const mockBlogPosts: BlogPostType[] = [
    mockBlogPost,
    {
        ...
        tags: [CategoriesEnum.REACT, CategoriesEnum.TYPESCRIPT],
    },
    {
        ...mockBlogPost,
        _id: '3',
        ...
        tags: [CategoriesEnum.HEROKU, CategoriesEnum.TYPESCRIPT],
    },
    {
        ...mockBlogPost,
        _id: '4',
        ...
        tags: [CategoriesEnum.DOTNET, CategoriesEnum.REACT],
    },
    {
        ...mockBlogPost,
        _id: '5',
    ...
    },
    {
        ...
        tags: [CategoriesEnum.NEXTJS, CategoriesEnum.REACT],
    },
];
